...
<fieldset>
  ...
  <select name="propiedad[idVendedor]" id="vendedor">
    ...
    <?php foreach($vendedores as $vendedor):  ?>
      <option <?php echo $propiedad->idVendedor === $vendedor->id ? 'selected' : ' '; ?> value="<?php echo sanitize($vendedor->id); ?>"><?php  echo sanitize($vendedor->nombre) . " " . sanitize($vendedor->apellido); ?></option>
    <?php  endforeach; ?>
